...
transform_feats = False             # Whether or not to transform features
...
if transform_feats:
    ...
    test_pids = pd.DataFrame(test_feat[:,0].copy(), columns=['pid'])
...
prediction.to_csv(prediction_path)      # Save prediction file.